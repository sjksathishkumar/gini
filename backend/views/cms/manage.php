...
<div class="breadcrumbs">
	<ul>
		<li><?php echo Html::a('Home',array('/admin')); ?><i class="icon-angle-right"></i></li>
...
<div class="row-fluid">
    <div class="span12 margin_top20">
	    <?php echo Html::a('Search','#',array('class'=>'search-button btn btn-inverse')); ?>
	 </div>
</div>
			...
			<div class="box-content nopadding">
				<form action="" name='cms-grid-list-form' id='cms-grid-list-form'>
					<?php $this->widget('zii.widgets.grid.CGridView', array(
						'id'=>'cms-grid1',
						'itemsCssClass' => 'table table-hover table-nomargin table-bordered', 
						'dataProvider'=>$model->searchOther(),
						//'filter'=>$model,
						'columns'=>array(
							array(
								'header'=>'Sr. No.',
