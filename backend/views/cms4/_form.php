...
$this->registerJs(
   '$("document").ready(function(){ 
        $("#cms-gird").on("pjax:end", function() {
            $.pjax.reload({container:".box-content"});  //Reload GridView
        });
    });'
);
?>
   ...
   <div class="span12">
	 ...
	 <div class="box-title">
	    ...
	    'options' => [
	       ...
	       <div class="controls">
                <?= $form->field($model, 'slug')->textInput()->label(false); ?>
	       ...
	       <div class="controls">
                <?= $form->field($model, 'pageMetaDescription')->textarea(['rows' => 4])->label(false); ?>
                      ...
                      <div class="control-group">
                <?= Html::activeLabel($model, 'author', ['label'=>'Author <span class="required">*</span>', 'class'=>'control-label']) ?>
	       ...
	       <div class="controls">
                <?= $form->field($model, 'author')->textInput()->label(false); ?>
                     ...
                     <div class="control-group">
                <?= Html::activeLabel($model, 'pageContent', ['label'=>'Content <span class="required">*</span>', 'class'=>'control-label']) ?>
	       
	       <div class="controls">
                <?php echo  $form->field($model, 'pageContent')->widget(TinyMCE::className(), ['options' => ['rows' => 6],'preset' => 'basic'
    ])->label(false); ?>
